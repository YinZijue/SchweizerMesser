...
# Form implementation generated from reading ui file 'pwd_add.ui'
#
...
class Ui_Dialog_pwd_add(object):
    def setupUi(self, Dialog_pwd_add):
        ...
        self.p_btn_pwd_pwd_reset = QtWidgets.QPushButton(self.groupBox)
        self.p_btn_pwd_pwd_reset.setGeometry(QtCore.QRect(10, 30, 75, 31))
        self.p_btn_pwd_pwd_reset.setObjectName("p_btn_pwd_pwd_reset")
        self.p_btn_pwd_pwd_cancel = QtWidgets.QPushButton(self.groupBox)
        self.p_btn_pwd_pwd_cancel.setGeometry(QtCore.QRect(100, 30, 75, 31))
        self.p_btn_pwd_pwd_cancel.setObjectName("p_btn_pwd_pwd_cancel")
        ...
        self.label_pwd_add_notice = QtWidgets.QLabel(self.groupBox_2)
        self.label_pwd_add_notice.setGeometry(QtCore.QRect(70, 55, 291, 21))
        ...
        self.label_pwd_add_notice.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setBold(True)
        font.setWeight(75)
        self.label_pwd_add_notice.setFont(font)
        self.label_pwd_add_notice.setObjectName("label_pwd_add_notice")
    ...
    def retranslateUi(self, Dialog_pwd_add):
        ...
        self.p_btn_pwd_pwd_reset.setText(_translate("Dialog_pwd_add", "重置"))
        self.p_btn_pwd_pwd_cancel.setText(_translate("Dialog_pwd_add", "取消"))

...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.stack_list.setCurrentIndex(4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.page_sys_param.setAccessibleName(_translate("MainWindow", "系统参数"))
        self.label_13.setText(_translate("MainWindow", "系统参数"))
        ...
        self.treeWidget.topLevelItem(2).setText(0, _translate("MainWindow", "系统参数"))

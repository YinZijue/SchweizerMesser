...
class Ui_Dialog_pwd_add(object):
    def setupUi(self, Dialog_pwd_add):
        ...
        self.lineEdit_password_add = QtWidgets.QLineEdit(self.groupBox_2)
        self.lineEdit_password_add.setGeometry(QtCore.QRect(70, 140, 291, 30))
        self.lineEdit_password_add.setMaxLength(32)
        ...
        Dialog_pwd_add.setTabOrder(self.lineEdit_title_add, self.lineEdit_usr_add)
        Dialog_pwd_add.setTabOrder(self.lineEdit_usr_add, self.lineEdit_password_add)
        Dialog_pwd_add.setTabOrder(self.lineEdit_password_add, self.lineEdit_url_add)
        Dialog_pwd_add.setTabOrder(self.lineEdit_url_add, self.plainTextEdit_remark_add)
        Dialog_pwd_add.setTabOrder(self.plainTextEdit_remark_add, self.comboBox_pwd_category_add)
        Dialog_pwd_add.setTabOrder(self.comboBox_pwd_category_add, self.p_btn_pwd_reset)
        Dialog_pwd_add.setTabOrder(self.p_btn_pwd_reset, self.p_btn_pwd_cancel)
        Dialog_pwd_add.setTabOrder(self.p_btn_pwd_cancel, self.p_btn_pwd_save_continue)
        Dialog_pwd_add.setTabOrder(self.p_btn_pwd_save_continue, self.p_btn_pwd_save_exit)
